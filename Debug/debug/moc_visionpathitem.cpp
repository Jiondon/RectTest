/****************************************************************************
** Meta object code from reading C++ file 'visionpathitem.h'
**
...
#error "The header file 'visionpathitem.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VisionPathItem_t, stringdata0) + ofs \
...
static const uint qt_meta_data_VisionPathItem[] = {
...
const QMetaObject *VisionPathItem::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *VisionPathItem::qt_metacast(const char *_clname)
{
