...
const QMetaObject LineItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LineItem.data,
      qt_meta_data_LineItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LineItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< LineItem*>(this));
