#ifndef VISIONELLIPSEITEM_NEW_H
#define VISIONELLIPSEITEM_NEW_H
...
class VisionEllipseItem_New : public VisionItem
{
    Q_OBJECT
public:
    VisionEllipseItem_New(bool rotation = false,VisionItem *parent = 0);
    /**
     * @brief       设置矩形
     */
