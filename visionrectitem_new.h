#ifndef VISIONRECTITEM_NEW_H
#define VISIONRECTITEM_NEW_H
...
class VisionRectItem_New : public QObject,public QGraphicsItem
{
    Q_OBJECT
public:
    explicit VisionRectItem_New(bool rotation,QGraphicsItem *parent = 0);
    /**
     * @brief       设置矩形
     */
